# play-track-promotion Specification

## Purpose
Promotion of an already-built AAB from the Play internal track to closed testing, open testing, and/or production in a single gated dispatch. Rollout fraction and in-app-update priority apply to production only; testing tracks skip idempotently; localized changelogs are reused per track behind one reviewer gate.
## Requirements

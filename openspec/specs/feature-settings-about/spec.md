# feature-settings-about Specification

## Purpose
The Settings → About surfaces: the About entry in Settings, an adaptive presentation of those surfaces, the About header and source link, Special Thanks rows backed by live profile data, and the open-source licenses screen.
## Requirements

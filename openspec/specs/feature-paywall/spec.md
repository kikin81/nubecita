# feature-paywall Specification

## Purpose
The standalone `:feature:paywall` module: a custom Compose Nubecita Pro paywall rendered with the design system rather than a drop-in provider UI, driven by an MVI presenter and carrying the subscription disclosures Play requires.
## Requirements

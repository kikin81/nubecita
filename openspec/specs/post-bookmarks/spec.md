# post-bookmarks Specification

## Purpose
Post bookmarking: bookmark state carried on the post model, an optimistic toggle kept consistent across every surface rendering that post, the bookmark action in the post action row, and analytics instrumentation.
## Requirements

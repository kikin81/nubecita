# feature-chats Specification

## Purpose
Chat list management for the DM conversation list: Chats/Requests segmentation, multi-select conversation actions that adapt to selection count and segment, and leaving a conversation modeled as a recoverable deferred undo. Conversation action failures are non-destructive.
## Requirements

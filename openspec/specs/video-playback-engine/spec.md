# video-playback-engine Specification

## Purpose
The shared video playback engine: a pooled playlist player with next-item prewarming, an exactly-one-active-playback invariant, and a decoder budget managed via lifecycle handoff — plus playback hardening, playback analytics, and battery discipline.
## Requirements

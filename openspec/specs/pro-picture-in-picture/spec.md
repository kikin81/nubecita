# pro-picture-in-picture Specification

## Purpose
Pro-gated picture-in-picture video playback: entitlement folded into a single choke-point flag, PiP entry with playback continuity, PiP UI and controls driven from the Activity/Compose layer rather than a ViewModel, and graceful degradation to an upsell when not entitled.
## Requirements

# post-audience Specification

## Purpose
The composer's post audience controls (threadgate + postgate): the audience chip, the picker, applying the chosen audience when posting, and persisting a saved audience default.
## Requirements

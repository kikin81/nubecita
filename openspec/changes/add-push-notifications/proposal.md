...
- `reference_atproto_kotlin_notification_lexicon_gap.md` says `registerPush` is missing from atproto-kotlin. As of `6.5.1`, `NotificationService.registerPush` + `unregisterPush` are present — the memory is stale and gets corrected when this lands.

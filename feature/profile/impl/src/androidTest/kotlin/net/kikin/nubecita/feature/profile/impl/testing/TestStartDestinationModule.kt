 ...
 * the classpath when running `:feature:profile:impl/src/androidTest/`,
 * so Hilt fails to construct `Navigator` without this stand-in.
 *
 * Returns [Profile] (the feature under test) since [DefaultNavigator]
...
internal object TestStartDestinationModule {
    ...
    @Singleton
    @StartDestination
    fun provideStartDestination(): NavKey = Profile(handle = null)
}

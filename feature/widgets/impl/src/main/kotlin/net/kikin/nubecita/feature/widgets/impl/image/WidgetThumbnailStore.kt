 ...
 *
 * Layout: `<cacheDir>/widget_thumbs/<account>/<postKey>.jpg`, where `<account>`
 ...
 * `<cacheDir>/widget_thumbs` via the secondary `@Inject` constructor.
 */
@Singleton
class WidgetThumbnailStore(
    ...
    ) : this(File(context.cacheDir, ROOT_DIR_NAME))

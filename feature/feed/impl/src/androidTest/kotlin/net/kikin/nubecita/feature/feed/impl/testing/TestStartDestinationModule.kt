 ...
 * the classpath when running `:feature:feed:impl/src/androidTest/`,
 * so Hilt fails to construct `Navigator` without this stand-in.
 *
 * Returns [Feed] (the feature under test) since [DefaultNavigator]
...
internal object TestStartDestinationModule {
    ...
    @Singleton
    @StartDestination
    fun provideStartDestination(): NavKey = Feed
}

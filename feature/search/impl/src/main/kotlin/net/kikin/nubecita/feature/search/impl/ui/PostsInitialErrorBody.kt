...
/**
 * Full-screen retry layout for the Posts tab's [SearchPostsError]
 * variants. Mirrors `:feature:chats:impl`'s ErrorBody pattern. Maps
 * each error variant to a title/body stringResource pair and a single

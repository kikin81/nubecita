...
import net.kikin.nubecita.feature.settings.impl.testing.FakeAuthRepository
...
/**
 * End-to-end Settings sign-out flow:
 *
 ...
 */
@HiltAndroidTest
class SettingsInstrumentationTest {
    @get:Rule(order = 0)
    ...
    fun signOut_success_callsAuthRepositoryExactlyOnce() {
        ...
        val signOutLabel = composeTestRule.activity.getString(R.string.settings_signout)
    ...
    fun switchAccount_tap_surfacesComingSoonSnackbar() {
        val switchAccountLabel =
            composeTestRule.activity.getString(R.string.settings_switch_account_label)
        val comingSoonText =
            composeTestRule.activity.getString(R.string.settings_switch_account_coming_soon)
    ...
    fun signOut_failure_surfacesErrorSnackbar() {
        ...
        val signOutLabel = composeTestRule.activity.getString(R.string.settings_signout)
        val signOutErrorText = composeTestRule.activity.getString(R.string.settings_signout_error)

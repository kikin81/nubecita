 ...
 */
@Singleton
internal class DefaultSharedMediaStore internal constructor(
    private val context: Context,
    private val dispatcher: CoroutineDispatcher,
    // Injectable so instrumented tests can drive the byte-cap boundary cheaply
    // (a 25 MB source is impractical to materialize) and the sweep age boundary.
    // Production uses the defaults via the @Inject secondary constructor below.
    ...
    ) : this(context, dispatcher, MAX_IMAGE_BYTES, MAX_AGE_MILLIS)
